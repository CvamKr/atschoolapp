...
class AttendanceTemplate extends StatefulWidget {
  const AttendanceTemplate({super.key});

  @override
  State<AttendanceTemplate> createState() => _AttendanceTemplateState();
}

class _AttendanceTemplateState extends State<AttendanceTemplate> {
  bool showIntervention = false;
